<ul class="nav navbar-nav">
	...
	<li class="language-btn dropdown">
		...
		<ul class="dropdown-menu">
			<li class="dropdown-item"><a href=""><img src="<?=base_url('web/images/id.png');?>" /> Indonesian</a></li>
			<li class="dropdown-item"><a href=""><img src="<?=base_url('web/images/eng.png');?>" /> English</a></li>
		</ul>
	</li>
	<li class="download-paypro dropdown">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">Download PayPro</a>
		<ul class="dropdown-menu">
