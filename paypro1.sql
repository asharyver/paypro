...
(null, 'Bawah', 1, 'Aman Pake Paypro, <br>#Jadilebih nyaman !', 'Tak perlu khawatir seperti kehilangan dompet atau pencurian uang tunai,<br>Transaksi menggunakan Paypro menggunakan password<br>\r\nyang hanya bisa di akses oleh pemilik account.', 'pro-210220181214.png'),
(null, 'Atas', 0, 'Bayar dengan Kode QR', 'Pake Paypro, kamu memiliki alternatif pembayaran untuk segala kebutuhan. Semudah pindai QR code, tidak perlu uang tunai, atau kartu, satu aplikasi, berbagai promo.', 'pro-230220180232.png'),
(null, 'Tengah', 0, 'Bayar apa aja <br>#PakePaypro Gampang', 'kamu akan mendapatkan penawaran terbaik untuk pembelian pulsa\r\nPaket Data, PLN, Transfer Uang dan bayar pakai QR\r\ndi toko favorit atau minimarket', 'about-210220181227.png');
